...
bot = telebot.TeleBot('7972862104:AAEZ0h29LU-JsnMQWP4dfez7rQamXmYpcoY')
...
def create_random_key(length=10):
    ...
    custom_key = f"RITIK-XYZ-{random_key.upper()}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𑁍┊XYX 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
